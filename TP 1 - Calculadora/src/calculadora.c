	...
	switch(opcion) {
		...
		case 4:
			...
			if (flag3 == 0) {
				...
				printf("No se realizaron los calculos porque no se ingresaron valores correctos.\n");
			}
			else {
				...
				printf("\ne) El resultado del Factorial A es: %ld\t El resultado del Factorial B es: %ld", factorialUno, factorialDos);
				printf("\n");
			}
